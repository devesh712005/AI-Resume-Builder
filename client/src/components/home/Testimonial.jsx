...
export const Testimonial = () => {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center gap-2 text-sm text-green-600 gb-green-400/10 rounded-full px-6 py-1.5">
          <BookUserIcon className="size-5.5 stroke-green-600" width={14} />
